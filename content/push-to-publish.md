...
### Hosting auf GitHub Pages [![GitHub Logo](/img/octocat.png){: .icon}](https://github.com/)
...
### Automatische Erstellung durch Travis CI [![Travis CI Logo](/img/travis.png){: .icon}](https://travis-ci.org/)
