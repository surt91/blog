...
![42 Hauptstädte in Amerika](/img/tsp.png){: .invertable}
...
### Nearest Neighbor
![Nearest Neighbor](/img/tsp_nearestNeighbor.png){: .invertable}
...
### Greedy
![Greedy](/img/tsp_greedy.png){: .invertable}
...
### Farthest Insertion
![Farthest Insertion](/img/tsp_farIn.png){: .invertable}
...
### Two-Opt
![Two-Opt](/img/tsp_twoOpt.png){: .invertable}
...
![Linear Programming](/img/tsp_LP.png){: .invertable}
...
### Concorde
![Optimale Tour](/img/tsp_opt.png){: .invertable}
